...
const champions = [
    ...
    { name: '崔斯特', cost: 1, traits: ['space_groove', 'magician'] },
    { name: '崔斯特（卡牌）', cost: 1, traits: ['space_groove', 'magician'] },
    { name: '贾克斯', cost: 1, traits: ['wood_spirit', 'weaver'] },
    { name: '提莫', cost: 1, traits: ['shepherd', 'ranger'] },
    { name: '蕾欧娜', cost: 1, traits: ['vanguard', 'nova'] },
    { name: '内瑟斯', cost: 1, traits: ['vanguard', 'berserker'] },
    { name: '波比', cost: 1, traits: ['wood_spirit', 'vanguard'] },
    { name: '凯特琳', cost: 1, traits: ['fate_weaver', 'ranger'] },
    { name: '亚托克斯', cost: 1, traits: ['nova', 'vanguard'] },
    { name: '贝蕾亚', cost: 1, traits: ['seabeast', 'fighter'] },
    { name: '茂凯', cost: 1, traits: ['nova', 'fighter'] },
    { name: '科加斯', cost: 1, traits: ['berserker', 'vanguard'] },
    
    // 2费英雄
    { name: '霞', cost: 2, traits: ['stargazer', 'ranger'] },
    { name: '卡莎', cost: 2, traits: ['dark_star', 'ranger'] },
    { name: '潘森', cost: 2, traits: ['stargazer', 'vanguard'] },
    { name: '布里茨', cost: 2, traits: ['wood_spirit', 'vanguard'] },
    { name: '阿卡丽', cost: 2, traits: ['nova', 'assassin'] },
    { name: '乐芙兰', cost: 2, traits: ['shepherd', 'magician'] },
    { name: '妖姬', cost: 2, traits: ['shepherd', 'magician'] },
    { name: '卑尔维斯', cost: 2, traits: ['seabeast', 'berserker'] },
    { name: '雷克塞', cost: 2, traits: ['seabeast', 'fighter'] },
    { name: '米利欧', cost: 2, traits: ['stargazer', 'shepherd'] },
    { name: '丽桑卓', cost: 2, traits: ['shepherd', 'magician'] },
    { name: '内瑟纳斯', cost: 2, traits: ['dark_star', 'bastion'] },
    
    // 3费英雄
    { name: '莫德凯撒', cost: 3, traits: ['vanguard', 'berserker'] },
    { name: '派克', cost: 3, traits: ['traveler', 'assassin'] },
    { name: '古拉加斯', cost: 3, traits: ['berserker', 'fighter'] },
    { name: '努努', cost: 3, traits: ['vanguard', 'nova'] },
    { name: '卡尔玛', cost: 3, traits: ['dark_star', 'shepherd'] },
    { name: '易', cost: 3, traits: ['berserker', 'challenger'] },
    { name: '俄洛伊', cost: 3, traits: ['vanguard', 'berserker'] },
    { name: '娜美', cost: 3, traits: ['shepherd', 'magician'] },
    { name: '厄加特', cost: 3, traits: ['mecha', 'berserker'] },
    { name: '奥恩', cost: 3, traits: ['vanguard', 'nova'] },
    { name: '佐伊', cost: 3, traits: ['magician', 'nova'] },
    { name: '小木灵', cost: 3, traits: ['wood_spirit', 'traveler'] },
    { name: '菲兹', cost: 3, traits: ['wood_spirit', 'assassin'] },
    { name: '欧蕾娜', cost: 3, traits: ['shepherd', 'magician'] },
    { name: '琴女', cost: 3, traits: ['traveler', 'psychic'] },
    { name: '璐璐', cost: 3, traits: ['stargazer', 'magician'] },
    
    // 4费英雄
    { name: '劫', cost: 4, traits: ['dark_star', 'assassin'] },
    { name: '厄运小姐', cost: 4, traits: ['stargazer', 'sniper'] },
    { name: '拉亚斯特', cost: 4, traits: ['nova', 'fighter'] },
    { name: '塔姆', cost: 4, traits: ['berserker', 'vanguard'] },
    { name: '菲奥娜', cost: 4, traits: ['nova', 'challenger'] },
    { name: '锐雯', cost: 4, traits: ['stargazer', 'vanguard'] },
    { name: '慎', cost: 4, traits: ['wood_spirit', 'vanguard'] },
    { name: '加里奥', cost: 4, traits: ['traveler', 'vanguard'] },
    { name: '纳尔', cost: 4, traits: ['wood_spirit', 'berserker'] },
    { name: '伊泽瑞尔', cost: 4, traits: ['future', 'ranger'] },
    { name: '阿萝拉', cost: 4, traits: ['mecha', 'magician'] },
    { name: '莫甘娜', cost: 4, traits: ['dark_star', 'vanguard'] },
    
    // 5费英雄
    { name: '奥瑞利安·索尔', cost: 5, traits: ['space_groove', 'oracle'] },
    { name: '亚索', cost: 5, traits: ['nova', 'challenger'] },
    { name: '凯尔', cost: 5, traits: ['judge', 'berserker'] },
    { name: '烬', cost: 5, traits: ['dark_star', 'sniper'] },
    { name: '巴德', cost: 5, traits: ['traveler', 'oracle'] },
    { name: '维克托', cost: 5, traits: ['shepherd', 'magician'] },
    { name: '格雷福斯', cost: 5, traits: ['nova', 'fighter'] },
    { name: '拉莫斯', cost: 5, traits: ['wood_spirit', 'vanguard'] },
    { name: '薇古丝', cost: 5, traits: ['nova', 'magician'] },
    { name: '娑娜', cost: 5, traits: ['stargazer', 'oracle'] },
    { name: '库奇', cost: 5, traits: ['future', 'sniper'] },
    { name: '千珏', cost: 5, traits: ['berserker', 'challenger'] },
    { name: '小法', cost: 5, traits: ['wood_spirit', 'magician'] },
    { name: '超级机甲', cost: 5, traits: ['mecha', 'vanguard'] }
];
